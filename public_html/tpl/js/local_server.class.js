...
class Local_Server{
    ...
    /** Dung de sinh de
        Output: json
     **/
    check_mark(paraInput, callback, callback_message){
        ...
        var checkCallback = function(isSuccess, errorCode, errorMessage, resultPara){
            ...
            REQUEST_CALCULATE_LEVEL_REQUEST(contentInput, function(rs){
                ...
                _msg.old_level = oldLevel;
                _msg.current_level = currentLevel;
                ...
                for (var i = 1; i <= currentLevel+1; i++) {
                    ...
                    var _need = {
                        game_type_id: gameTypeABC,
                        game_type_title: titles[gameTypeABC],
                        score: datas[gameTypeABC][currentLevel+1],
                        status: (arrayLevel[gameTypeABC]>currentLevel?"Hoàn Thành":"Chưa Đạt"),
                        passed: (arrayLevel[gameTypeABC]>currentLevel?true:false)
                    };
                    _needs[i-1] = _need;
                }
